      ...
      <div className="navbar">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-white rounded-box z-[1] mt-3 w-52 p-2 shadow">{navItems}</ul>
          </div>
          <a className="text-2xl text-black font-bold cursor-pointer">Librazen</a>
        </div>
        <div className="navbar-end space-x-3">
          ...
          <div className="">
            <a className="bg-black text-white px-3 py-2 pr-5 rounded-md hover:bg-slate-800 duration-300 cursor-pointer mr-4" onClick={showModal}>Login</a>
          </div>
        </div>
      </div>
      <Login />
