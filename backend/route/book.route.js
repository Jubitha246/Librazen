...
import { getBook,deleteBook,addBook,updateBook,getBooksByCategory,getAnalytics} from '../controller/book.controller.js';
...
router.get('/analytics', isAuth, isAdmin, getAnalytics);
